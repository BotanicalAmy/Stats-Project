...
The odds ratio for this model can be calculated as:

$$odds \space ratio = e^{\widehat \beta_1} = e^{-0.0117484} = 0.988324$$ 

Therefore, for every 1 day increase in LeadTime, the predicted odds of cancelling the hotel booking decreases by a factor of 0.988. To further Gold Mine Resorts understanding of these statistics, Visuals of the probabilities and odds of cancellation are included below.

The predicted $\widehat{b}$ is statistically significant, this is because the hypothesis test bellow:

$$H_0: \beta_1 = 0, H_a: \beta_1 \neq 0$$

LeadTime has a a p-value of less than $2*10^{-16}$, we have strong evidence to reject the null hypothesis in favor of the alternative. Conclusively, LeadTime is useful predictor for predicting cancellation rates.
...
**odds ratio for Status using HasRequests:**
